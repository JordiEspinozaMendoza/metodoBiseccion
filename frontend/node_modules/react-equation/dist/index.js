...
var equationParser = require('equation-parser');
var equationResolver = require('equation-resolver');
...
function variable(_ref) {
  ...
  return {
    ...
    children: /*#__PURE__*/React__default.createElement(React__default.Fragment, null, main, indices.map(function (indexName, idx) {
...
function block(_ref) {
  ...
  return {
    ...
    children: /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Parens, {
      height: content.height
    }), content.elements, /*#__PURE__*/React__default.createElement(Parens, {
      height: content.height,
      flip: true
    }))
  };
...
function func(node) {
  ...
  return {
    ...
    children: /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("span", {
      style: {
        position: 'relative',
        top: "".concat(argRendering.aboveMiddle - nameRendering.aboveMiddle, "em")
      }
    }, nameRendering.elements), /*#__PURE__*/React__default.createElement(Parens, {
      height: argRendering.height
    }), argRendering.elements, /*#__PURE__*/React__default.createElement(Parens, {
      height: argRendering.height,
      flip: true
    }))
  };
...
function fraction(_ref) {
  ...
  return {
    ...
    }, top.elements), /*#__PURE__*/React__default.createElement("span", {
...
function power(_ref) {
  ...
  return {
    ...
    }, base.elements), /*#__PURE__*/React__default.createElement("span", {
...
function matrix(_ref) {
  ...
  return {
    ...
    }, /*#__PURE__*/React__default.createElement("tbody", null, content.map(function (row, rowIdx) {
    ...
    }))), /*#__PURE__*/React__default.createElement(Parens, {
      height: height,
      type: "[]",
      flip: true
    }))
...
function sum(_ref) {
  ...
  var rendering = renderInternal(wrapParenthesis(expression || {
    ...
    children: /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("span", {
      ...
      style: styles$4.icon
    }, "\u03A3"), /*#__PURE__*/React__default.createElement("span", {
      style: _objectSpread2({
        height: "".concat(bottom.height, "em")
      }, styles$4.small)
    }, bottom.elements))
...
function abs(_ref) {
  ...
  return {
    ...
    }), content.elements, /*#__PURE__*/React__default.createElement("span", {
      style: _objectSpread2(_objectSpread2({}, styles$5.line), {}, {
        right: '0.1em'
      })
    }))
...
function sqrt(_ref) {
  ...
  return {
    ...
    belowMiddle: content.belowMiddle,
    children: /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(RootSymbol, {
...
var render = function render(node) {
  ...
  if (node.type === 'parser-error') {
    return /*#__PURE__*/React__default.createElement("span", baseProps, /*#__PURE__*/React__default.createElement("div", null, node.equation.substring(0, node.start), /*#__PURE__*/React__default.createElement("span", {
      style: {
        color: 'red'
      }
    }, node.equation.substring(node.start, node.end + 1)), node.equation.substring(node.end + 1)), /*#__PURE__*/React__default.createElement("div", null, (errorHandler[node.errorType] || defaultErrorHandler)(node)));
  }
  ...
  if (node.type === 'resolve-error' && node.node) {
    ...
    return /*#__PURE__*/React__default.createElement("span", baseProps, /*#__PURE__*/React__default.createElement("span", {
      style: {
        height: "".concat(_height, "em"),
        display: 'inline-block'
      }
    }, _elements), /*#__PURE__*/React__default.createElement("br", null), (errorHandler[node.errorType] || defaultErrorHandler)(node));
  }

  if (node.type === 'resolve-error') {
    return /*#__PURE__*/React__default.createElement("span", baseProps, (errorHandler[node.errorType] || defaultErrorHandler)(node));
  }
  ...
  return /*#__PURE__*/React__default.createElement("span", _extends({}, baseProps, {
    style: _objectSpread2({
...
function toRendering(parts) {
  ...
  return {
    ...
    elements: parts.map(function (part, idx) {
      return /*#__PURE__*/React__default.createElement(part.type, _objectSpread2({
        key: idx
...
var Equation = function Equation(_ref) {
  ...
  return render(equationParser.parse(value), {
...
var EquationEvaluate = function EquationEvaluate(_ref) {
  ...
  var equation = equationParser.parse(value);
  var unitEquation = unit ? equationParser.parse(unit) : null;
  var tree = equationResolver.format(equation, unitEquation, {
...
var EquationEvaluatePreparsed = function EquationEvaluatePreparsed(_ref) {
  ...
  var tree = equationResolver.format(value, unit, {
    variables: _objectSpread2(_objectSpread2({}, globalVariables), localVariables),
    functions: _objectSpread2(_objectSpread2({}, globalFunctions), localFunctions),
...
exports.EquationEvaluate = EquationEvaluate;
exports.EquationEvaluatePreparsed = EquationEvaluatePreparsed;
exports.EquationOptions = EquationOptions;
exports.EquationPreparsed = EquationPreparsed;
exports.defaultErrorHandler = defaultErrorHandler$1;
